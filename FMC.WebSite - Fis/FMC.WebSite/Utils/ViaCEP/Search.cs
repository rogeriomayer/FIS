...
namespace FMC.Solutions.NTU.Library.Class.ViaCEP
{
    public class Search
    {
        ...
        public static Fis.Utils.ViaCEP.Model.ViaCEP ByZipCode(int zipCode)
        {
            try
            {
                var jsonResult = ViaCEPServices.GetAddressByCEP(zipCode, ViaCEPTypes.Json);
                var objectResult = JsonConvert.DeserializeObject< Fis.Utils.ViaCEP.Model.ViaCEP >(jsonResult);
                return objectResult;
            }
            catch (ViaCEPException ex)
            {
        ...
        /// <returns>Object with address result</returns>
        /// 
        public static ICollection<FMC.Fis.Utils.ViaCEP.Model.ViaCEP> ByAddress(string state, string city, string address)
        {
            try
            {
                ...
                ICollection<FMC.Fis.Utils.ViaCEP.Model.ViaCEP> objectResult = JsonConvert.DeserializeObject<ICollection< Fis.Utils.ViaCEP.Model.ViaCEP >>(jsonResult);
                return objectResult;
            }
            catch (ViaCEPException ex)
            {
