...
namespace FMC.FIS.Business.DAO
{
    public class PersonDAO : AbstractRepositoryPersistence<Person>
    {
        ...
        public ICollection<Person> GetByMailSendNews(int idProductType, DateTime dtLead, int count)
        {
            ...
            query.Append(" 		and LE.Age in (78,79,80,81,82,281,361,721,1081,1800) ");
            query.Append(" 	) ");
        ...
        public ICollection<Person> GetPersonSendRCSNews()
        {
            ...
            //não esquecer de mudar a frase do RCS tirando o 06/05
            query.Append(" and a.age between 250 and 9995");
            //query.Append(" and (dsproduct like '%5' )");
            query.Append(" and (dsproduct like '%9' )");
            ...
            //query.Append(" and a.debitbalance < 1200 ");
...
*/
            ...
            query.Append(" 	AND ura.DTINSERT >= getdate() - 15");
            query.Append(" ) ");
            ...
            query.Append(" 	WHERE rcs.idPerson = Pe.idPerson ");
            //query.Append(" 	AND rcs.DTINSERT between CONVERT(DATE, '2025-12-23') and '2026-01-01' ");
            query.Append(" 	AND rcs.DTINSERT >= CONVERT(date, getdate() - 15) ");
            query.Append(" ) ");
