...
namespace FMC.FIS.EnvioEmailCredz
{
    public class EnvioEmailThread
    {
                    ...
                    if (envioEmail.Atraso >= 78)
                    {
                        ...
                        */
                        ...
                        /*if (body.Contains("A Credz tem uma oportunidade exclusiva para ajudar você a limpar seu nome e sair dos órgãos de proteção, como Serasa e SPC"))
                            title = "COM ENTRADA DE APENAS R$70,00 RENEGOCIE SEU " + envioEmail.NomeCartao;
        ...
        private string GetBody(EnvioEmailSMS envioEmail)
        {
            ...
            body.Append("<img alt=\"\" style=\"width:60px\" src=\"https://www.dmcardweb.com.br/src/public/images/brand/logo-dm.svg\">");
            body.Append("</a>");
            body.Append("</p>");
