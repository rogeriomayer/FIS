...
namespace FMC.Digicob.DM.Models
{
    ...
    public class AgreementResponse
    {
        ...
        public virtual List<AgreementsInstallmentsResponse> Installments { get; set; }

        [JsonPropertyName("contracts")]
        public virtual List<AgreementContractResponse> Contracts { get; set; }

    }

    public class AgreementsInstallmentsResponse
    {
    ...
    public class BilletResponse
    {
        ...
        public JsonElement? JsonBilletRaw { get; set; }

        public string? JsonBillet => JsonBilletRaw?.GetRawText();
        */
    ...
    public class AgreementsContractResponse
    {
